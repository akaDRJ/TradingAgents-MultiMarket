...
MODEL_OPTIONS: ProviderModeOptions = {
    ...
    "minimax": {
        "quick": [
            (
                "MiniMax-M2.7-highspeed - Fastest, 100 TPS, 200K ctx",
                "MiniMax-M2.7-highspeed",
            ),
            (
                "MiniMax-M2.5-highspeed - Fast, cost-effective, 100 TPS",
        ...
        "deep": [
            ...
            ("MiniMax-M2.7 - Latest flagship, 60 TPS, 200K ctx", "MiniMax-M2.7"),
